    ...
    <section className="w-full bg-success-700">
      <div className="wrapper py-12 md:py-[100px] space-y-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1164px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 overflow-hidden">
          ...
          <Fade direction={"down"}>
            <div className="w-full lg:w-[520px] h-auto lg:h-[453px] rounded-[40px] md:rounded-[100px] bg-success-300 relative flex items-center justify-center">
              <Image
                src="/images/ceoabout.png"
                alt="CEO Image"
                className="w-full h-full rounded-[40px] md:rounded-[100px] object-cover"
                width={520}
                height={453}
              />
              <div className="w-full h-[80px] sm:h-[104px] rounded-2xl rounded-bl-full rounded-br-full border-t p-5  space-y-1 sm:space-y-2 bg-success-300 border-success-500 absolute bottom-0 text-center">
